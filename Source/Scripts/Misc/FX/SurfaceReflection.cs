...
public class SurfaceReflection : MonoBehaviour {
	...
	public float reflectionFOV = 60f;
    ...
    public void OnWillRenderObject() {
        ...
        float d = -Vector3.Dot (transform.up, pos) - m_clipPlaneOffset;
        ...
        Vector4 clipPlane = CameraSpacePlane(reflectionCamera, pos, transform.up, 1.0f);
        Matrix4x4 projection = cam.projectionMatrix;
        CalculateObliqueMatrix (ref projection, clipPlane);
        reflectionCamera.projectionMatrix = projection;
		
		reflectionCamera.fieldOfView = reflectionFOV;
    ...
    private void CreateSurfaceObjects(Camera currentCamera, out Camera reflectionCamera)
    {
        ...
        {
            GameObject go = new GameObject("Surface Reflection Camera (" + GetInstanceID() + ")", typeof(Camera), typeof(Skybox));
