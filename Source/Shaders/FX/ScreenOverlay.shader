...
Shader "Hidden/Screen Overlay" {
	...
	v2f vert( appdata_img v ) { 
		...
		o.uv[0] = float2(
			dot((v.texcoord.xy - _UVDetail.z) * _UVDetail.x, _UV_Transform.xy),
			dot((v.texcoord.xy + _UVDetail.w) * _UVDetail.y, _UV_Transform.zw)
		);
